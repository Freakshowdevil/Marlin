...
#define STRING_CONFIG_H_AUTHOR "(Freakshow, Ender-3)" // Who made the changes.
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.200   // Z offset: -below +above  [the nozzle]
